...
<head>
	<title>用户角色分配</title>
	<link rel="stylesheet" href="${app}/staticfile/css/zTreeStyle.css" type="text/css">
	<script type="text/javascript" src="${app}/staticfile/js/jquery-1.4.4.min.js"></script>
	<script type="text/javascript" src="${app}/staticfile/js/jquery.ztree.core-3.5.min.js"></script>
	<script type="text/javascript" src="${app}/staticfile/js/jquery.ztree.excheck-3.5.min.js"></script>
	...
	<body>
		<form name="icform" method="post">
		  ...
		  <div class="textbox-title">
			<img src="${app}/staticfile/skin/default/images/icon/currency_yen.png"/>
		    用户角色分配
		  </div> 
		<div>
