...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
	<li id="view"><a href="#" onclick="formSubmit('backtoview','_self');this.blur();">查看</a></li>
	<li id="new"><a href="#" onclick="formSubmit('backtocreate','_self');this.blur();">新增</a></li>
	<li id="update"><a href="#" onclick="formSubmit('backtoupdate','_self');this.blur();">修改</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
		...
		<td class="name1">${u.username}</td>
		<td><a href="backtoview?id=${u.id}">${u.userInfo.nickname}</a></td>
