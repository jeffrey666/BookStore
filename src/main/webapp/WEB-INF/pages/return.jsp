       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div id="content">
				...
				<div>
					<tr>
						<td class="tableHeader"><input type="checkbox" name="selid" onclick="checkAll('bookId',this)"></td>
						<td class="tableHeader">序号</td>
						<td class="tableHeader">书名</td>
						<td class="tableHeader">作者</td>
				...
				<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
					...
					<td><a href="toview?bookId=${b.bookId}">${b.bookName}</td>
					<td>${b.bookInfo.auther}</a></td>
					<td>
						<c:if test="${b.state==1}"><a href="stop?userId=${u.userId}"><font color="green">已归还</font></a></c:if>
						<c:if test="${b.state==0}"><a href="start?userId=${u.userId}"><font color="red">未归还</font></a></c:if>
					</td>
					</tr>
				</c:forEach>
 			 	<span class="input_span"><input type="submit" value="还书"></span>			
            </form>
            </div>
        </div> 
