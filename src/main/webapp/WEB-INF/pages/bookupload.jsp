...
<html>
	<head>
	    ...
	    <script src="<%=request.getContextPath() %>/staticfile/js/jquery-1.6.2.js"></script>
	...
	<%@include file="_head.jsp" %>
		...
		action="<%= request.getContextPath() %>/saveBookUpload.action" method="POST" enctype="multipart/form-data">
			...
			<table>
				...
				<tr>
					...
					<td>
						<input type="text" name="bookInfo.press"
