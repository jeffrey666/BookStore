			...
			<div class="left_content">
				...
				<div class="feat_prod_box_details">
					...
					<div class="contact_form">
						...
						<div>
							<input name="user_id" value="${_CURRENT_USER.id } " type="hidden" >
						</div>
						<div><input name="userInfo.userInfoId" value="${_CURRENT_USER.userInfo.userInfoId } " type="hidden" ></div>
							...
							<div class="form_row">
								...
								<input  class="contact_input" type="password" name="old_psw"  />
							</div>
							<div class="form_row">
								<label class="contact"><strong>新密码:</strong></label>
								<input  class="contact_input" type="password" name="new_password"   />
							</div>
							<div class="form_row">
								<label class="contact"><strong>确认密码:</strong></label>
								<input  class="contact_input" type="password" name="new_password_confirm"   />
							</div>
