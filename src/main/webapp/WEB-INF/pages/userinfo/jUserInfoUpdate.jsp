...
<form name="icform" method="post" target="_self"  action="/user/userinfo/update" >
	...
	<div class="header">
        ...
        <div id="menu">
            ...
            <li><a href="/user/toChangePassword.action" target="_top" >密码管理</a></li>
            </ul>
        </div>     
			...
			<div class="left_content">
				...
				<div class="feat_prod_box_details">
					...
					<div class="contact_form">
						...
						<div><input name="id" value="${_CURRENT_USER.id } " type="hidden" ></div>
						<div><input name="userInfo.userInfoId" value="${_CURRENT_USER.userInfo.userInfoId } " type="hidden" ></div>
							
							<div class="form_row">
								<label class="contact"><strong>用户名:</strong></label>
								 <input class="contact_input" type="text" name="username" value="${_CURRENT_USER.username }" readonly="readonly" />
							</div>


							<div class="form_row">
								<label class="contact"><strong>状态:</strong></label> 
							...
							<div class="form_row">
								...
								<input class="contact_input" type="text" name="userInfo.nickname" value="${_CURRENT_USER.userInfo.nickname }" />
							</div>
							...
							<div class="form_row">
								...
								<input class="contact_input"  type="text" name="userInfo.email" value="${_CURRENT_USER.userInfo.email }" onblur="checkEmail()"  />
								<span></span>
								<input hidden="hidden" class="register" style="width: 60px;height: 18px;font-size: 10px" type="button"   value="验证邮箱" onclick="onclickVerifyEamil(this)" />
								
							</div>
							
							<div class="form_row">
								<label class="contact"><strong>性别:</strong></label> 
								<input  class="contact_input" type="text" name="userInfo.gender" value="${_CURRENT_USER.userInfo.gender }" />
							</div>
						
							<div class="form_row">
								<label class="contact"><strong>地址:</strong></label> 
								<input class="contact_input" type="text" name="userInfo.address" value="${_CURRENT_USER.userInfo.address }" />
							</div>
							
							
							<div class="form_row">
								<label class="contact"><strong>身份证号:</strong></label> 
								<input  class="contact_input" type="text" name="userInfo.cardNo" value="${_CURRENT_USER.userInfo.cardNo }" />
							</div>
						
							<div class="form_row">
								<label class="contact"><strong>积分:</strong></label> 
								<input class="contact_input" type="text" name="userInfo.score" value="${_CURRENT_USER.userInfo.score }" readonly="readonly" />
							...
							<div class="form_row">
								...
								<input  class="contact_input" type="text" name="userInfo.telephone" value="${_CURRENT_USER.userInfo.telephone }" />
							</div>
							...
							<div class="form_row">
								<input type="button"  class="register" value="返回" onclick="window.history.back();" />
