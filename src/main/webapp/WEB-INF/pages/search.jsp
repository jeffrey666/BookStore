			...
			<div class="left_content">
				...
				<div id="content">
					...
					<form method="post" action="/search/search">
						<div id="search_div">
							<span class="input_span">书名：<input type="text"
								name="bookName" value="${book.bookName }" /></span> <span
								class="input_span">书籍种类： <select name="bookInfo.category">
									<option>无选择</option>
									<option value="文学类"
						...
						<div id="search_div2">
							<span class="input_span">作者：<input type="text"
								name="bookInfo.author" value="${book.bookInfo.author }" /></span>
						</div>
						<div id="search_div3">
							<span class="input_span">书籍出版日期年限：<input type="date"
								name="bookInfo.pubDate"
					...
					<div class="pagination">
						<c:if test="${pageBean!=null }">
							...
							<c:if test="${pageBean.currentPage>1}">
								<a
									href="${app}/search/search?currentPage=${pageBean.currentPage-1}"><<</a>
							</c:if>
							<input id="totalPageNum" value="${pageBean.totalPage }"
								type="hidden" />
							...
							<span> 转到第 <input id="changeNum" type="text"
								name="currentPage" value="${pageBean.currentPage}" />页<a
