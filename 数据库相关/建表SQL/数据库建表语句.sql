...
CREATE TABLE `user_info` (
  ...
  `email` VARCHAR(40) CHARACTER  DEFAULT NULL COMMENT '邮箱',
  `address` VARCHAR(200) CHARACTER  DEFAULT NULL COMMENT '地址',
  `card_no` VARCHAR(20) CHARACTER DEFAULT NULL COMMENT '身份证号',
